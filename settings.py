...
# Change lot size and timeframe from:
...
# ─── PRODUCT CONFIG ────────────────────────────
# Delta India uses BTCUSD (NOT BTCUSDT) for the BTC perpetual future
SYMBOL       = os.environ.get("SYMBOL", "BTCUSD")
PRODUCT_ID   = int(os.environ.get("PRODUCT_ID", 27))
LOT_SIZE_BTC = 0.001

# ══════════════════════════════════════════════
# SET THESE IN RENDER ENVIRONMENT VARIABLES
# DEFAULT_LOTS      = 100   (100 lots = 0.1 BTC)
# DEFAULT_TIMEFRAME = 5     (1/3/5/15/30/60/240)
# ══════════════════════════════════════════════
DEFAULT_LOTS      = int(os.environ.get("DEFAULT_LOTS",      100))
DEFAULT_TIMEFRAME = str(os.environ.get("DEFAULT_TIMEFRAME", "5"))
